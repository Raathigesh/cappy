...
export default class InvocationHandler {
  ...
  private emitResult(extensionName: string, methodName: string, result: any) {
    console.log('Emitting results', extensionName, methodName, result);
